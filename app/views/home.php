			...
			<div class="mid-container">
										...
										<div class="skills-container clear">
											...
											<ul>
												<?php if(!empty($user['proskill1'])): ?>
													<li class="skill"><button type="button"><?php echo e($user['proskill1']); ?></button></li>
												<?php endif; ?>
												<?php if(!empty($user['proskill2'])): ?>
													<li class="skill"><button type="button"><?php echo e($user['proskill2']); ?></button></li>
												<?php endif; ?>
												<?php if(!empty($user['proskill3'])): ?>
													<li class="skill"><button type="button"><?php echo e($user['proskill3']); ?></button></li>
												<?php endif; ?>
											</ul>
										</div>
									</div>
				...
				<div class="btn-container">
					<a href="<?php echo BASE_URL; ?>/mockup.php">
						<button type="button" class="btn-link candidates">Explore Candidates</button>
					</a>
					
					<a href="#">
						<button type="button" class="btn-link testimonials">Employer Testimonials</button>
					</a>
				</div>
			</div>
